...
const issueLink = new Link({
  title: 'Leave Issue',
  href: 'https://github.com/Praktikum-krivoruchkoND/middle.messenger.praktikum.yandex/issues',
});
...
class PageContent extends Block {
  ...
  render(): HTMLElement {
    ...
    status.innerText = 'Something went totaly wrong :(';

    container.appendChild(title);
    container.appendChild(status);
    container.appendChild(backLink.getContent());
    container.appendChild(issueLink.getContent());
